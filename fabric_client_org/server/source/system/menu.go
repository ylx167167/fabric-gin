...
func (m *menu) Initialize() error {
	entities := []system.SysBaseMenu{
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "dashboard", Name: "dashboard", Component: "view/dashboard/index.vue", Sort: 1, Meta: system.Meta{Title: "部署合约", Icon: "setting"}},
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "about", Name: "about", Component: "view/about/index.vue", Sort: 7, Meta: system.Meta{Title: "合约查询", Icon: "info"}},
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "http://127.0.0.1:7070/#/login", Name: "http://127.0.0.1:7070/#/login", Component: "/", Sort: 0, Meta: system.Meta{Title: "Hyperledger Explorer", Icon: "s-home"}},
